  ...
  return (
    <>
      ...
      >
        ...
        <div className="container pb-[100px] pt-[300px] md:pb-[140px] md:pt-[340px] xl:pb-[180px] xl:pt-[380px] 2xl:pb-[220px] 2xl:pt-[420px]">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div
                ...
                data-wow-delay=".2s"
              >
                <h1 className="mb-5 font-bold text-3xl leading-tight text-white sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight">
