  ...
  return (
    <section className="bg-color-black m-auto relative z-10 py-16 md:py-20 lg:py-28">
      <div className="w-5/6 m-auto">
        <h3 className="mb-10 frank text-center text-3xl font-semibold text-white xl:text-4xl">
        ...
        <h3 className="mt-10 frank text-center text-3xl font-semibold text-white xl:text-4xl">
