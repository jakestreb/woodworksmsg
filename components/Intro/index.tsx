const Intro = () => {
  return (
    <section id="intro" className="py-16 md:py-20 lg:py-28">
      <div className="container w-full grid">
          <div className="mb-16">
            ...
            <p className="text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed">
              This revolutionary therapy device helps restore range of motion and
              improve quality of life after major joint injuries and surgeries. With the option to
              apply a smart device to capture progress data and ensure daily use in the home.
            </p>
            <h3 className="mb-4 text-xl font-bold text-black dark:text-white sm:text-2xl lg:text-xl xl:text-2xl">
              NICE1
            </h3>
            <p className="text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed">
              This portable cold compression therapy system delivers targeted relief,
              promoting faster healing and reducing pain—a versatile tool for in-clinic therapy
              and as a convenient patient take-home solution.
            </p>
          </div>
          <div className="mb-8">
              <h3 className="mb-4 text-xl font-bold text-black dark:text-white sm:text-2xl lg:text-xl xl:text-2xl">
          ...
          <div className="mb-8">
              ...
              <ul className="list-disc text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed">
                <li>Explore our Physical Therapy Solutions</li>
                <li>Learn More About Practice Solutions</li>
